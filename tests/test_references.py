...
def test_references():
    ...
    src = """
        ...
        <https://testdirektoratet.no/model/dataset/reference>
                a                   dcat:Dataset ;
                dct:hasVersion      <https://testdirektoratet.no/model/dataset/hasVersion> ;
                dct:isVersionOf     <https://testdirektoratet.no/model/dataset/isVersionOf> ;
                dct:isPartOf        <https://testdirektoratet.no/model/dataset/isPartOf> ;
                dct:hasPart         <https://testdirektoratet.no/model/dataset/hasPart> ;
                dct:references      <https://testdirektoratet.no/model/dataset/references> ;
                dct:isReferencedBy  <https://testdirektoratet.no/model/dataset/isReferencedBy> ;
                dct:replaces        <https://testdirektoratet.no/model/dataset/replaces> ;
                dct:isReplacedBy    <https://testdirektoratet.no/model/dataset/isReplacedBy> ;
                dct:requires        <https://testdirektoratet.no/model/dataset/requires> ;
                dct:isRequiredBy    <https://testdirektoratet.no/model/dataset/isRequiredBy> ;
                dct:relation        <https://testdirektoratet.no/model/dataset/relation> ;
                dct:source          <https://testdirektoratet.no/model/dataset/source> ."""
